...
<body>
  <div class="d-flex-wrapper">
    ...
    <div class="w-100 flex-grow-1 d-flex flex-column">
      <div class="header d-flex justify-content-between align-items-center">
        <h3 class="mb-0"><i class="bi bi-robot me-2"></i>IA - Suporte N0</h3>
  ...
  <script>
    ...
    async function enviarImagem(file) {
      ...
      reader.onloadend = async function() {
        ...
        try {
          const resp = await fetch('https://apibotprojeton0.clipp.com.br/upload-imagem?user_id=' + window.USER_ID, {
            method: 'POST',
            body: formData
          });
    ...
    async function enviarAudio(file) {
      ...
      try {
  const resp = await fetch('https://apibotprojeton0.clipp.com.br/upload-audio?user_id=' + window.USER_ID, {
          method: 'POST',
          body: formData
        });
  ...
  await fetch('https://apibotprojeton0.clipp.com.br/avaliacao', {
        method: 'POST',
    ...
    async function enviar(pergunta) {
      ...
      try {
  const resp = await fetch('https://apibotprojeton0.clipp.com.br/consultar', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    async function atualizarMedias() {
      try {
  let resp = await fetch('https://apibotprojeton0.clipp.com.br/media-avaliacoes');
  ...
  let resp7 = await fetch('https://apibotprojeton0.clipp.com.br/media-avaliacoes?dias=7');
