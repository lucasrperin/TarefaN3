...
-- CriaÃ§Ã£o do controle de ConversÃ£o
...
CREATE TABLE IF NOT EXISTS TB_ESCUTAS (
    ...
    P_N ENUM('Sim', 'Nao') NULL DEFAULT NULL,
...
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippMei (5 usuÃ¡rios)');
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippPro (1 usuÃ¡rio)');
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippPro (2 usuÃ¡rios)');
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippPro (3 usuÃ¡rios)');
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippPro (4 usuÃ¡rios)');
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippPro (5 usuÃ¡rios)');
INSERT INTO TB_PLUGIN (nome) VALUES ('LicenÃ§a Adicional ClippPro (a partir de 6 usuÃ¡rios');
...
INSERT INTO TB_PLUGIN (nome) VALUES ('ZWeb - PrÃ©-venda gerencial');
INSERT INTO TB_PLUGIN (nome) VALUES ('ZWeb - Ecommerce prÃ³prio');
INSERT INTO TB_PLUGIN (nome) VALUES ('ZWeb - IntegraÃ§Ãµes com marketplaces');
INSERT INTO TB_PLUGIN (nome) VALUES ('ZWeb - OS e NFSe');
INSERT INTO TB_PLUGIN (nome) VALUES ('ZWeb - Retaguarda offline');
INSERT INTO TB_PLUGIN (nome) VALUES ('ZWeb - Tabela de PreÃ§os');
...
CREATE TABLE IF NOT EXISTS TB_INDICACAO (
    id INT AUTO_INCREMENT PRIMARY KEY,
    plugin_id INT NOT NULL,       -- ReferÃªncia ao plugin na TB_PLUGIN
    data DATE NOT NULL,
    cnpj VARCHAR(20),
    serial VARCHAR(50),
    contato VARCHAR(100),
    fone VARCHAR(50),
    user_id INT NOT NULL,         -- ReferÃªncia ao usuÃ¡rio que cadastrou a indicaÃ§Ã£o (TB_USUARIO)
	idConsultor INT NOT NULL,	  -- ReferÃªncia ao consultor que editou a indicaÃ§Ã£o (TB_USUARIO)
    status ENUM('Faturado', 'Pendente', 'Cancelado') NOT NULL DEFAULT 'Pendente',
    vlr_total numeric(18,4),
    n_venda int,
    revenda TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Indica se a indicaÃ§Ã£o foi para revenda: 1=Sim, 0=NÃ£o'
...
INSERT INTO TB_NIVEL (descricao) VALUES ('NÃ­vel 1');
INSERT INTO TB_NIVEL (descricao) VALUES ('NÃ­vel 2');
INSERT INTO TB_NIVEL (descricao) VALUES ('NÃ­vel 3');
INSERT INTO TB_NIVEL (descricao) VALUES ('NÃ­vel 4');
INSERT INTO TB_NIVEL (descricao) VALUES ('Exclusivo');
INSERT INTO TB_NIVEL (descricao) VALUES ('Comercial');
INSERT INTO TB_NIVEL (descricao) VALUES ('SupervisÃ£o');
INSERT INTO TB_NIVEL (descricao) VALUES ('GestÃ£o');
INSERT INTO TB_NIVEL (descricao) VALUES ('ConversÃ£o');
...
-- Indicadores para todos os nÃ­veis (Grupo ALL)
...
-- Indicadores para NÃ­vel 1, NÃ­vel 2 e Exclusivo
INSERT INTO TB_CRITERIOS (nome, peso) VALUES
('elogios_atendimento_externo', 1.0),
('nota_1_plausivel', -1.0);

-- Indicadores para NÃ­vel 3
INSERT INTO TB_CRITERIOS (nome, peso) VALUES
('elogio_interno_auxilio', 1.0),
('retorno_analise', -1.0);

-- Indicadores para ConversÃ£o
INSERT INTO TB_CRITERIOS (nome, peso) VALUES
...
CREATE TABLE TB_TREINAMENTOS (
    ...
    duracao INT NOT NULL DEFAULT 30,                   -- DuraÃ§Ã£o do agendamento em minutos
...
CREATE TABLE TB_META (
    ...
    menor_melhor    TINYINT(1)  NOT NULL DEFAULT 0,        -- 1 = menor Ã© melhor
    ...
    meta_qtd        INT NULL COMMENT 'Meta em nÃºmero de unidades',
...
CREATE TABLE TB_OKR_ATINGIMENTO (
    ...
    UNIQUE KEY uq_meta_mes (idMeta, ano, mes),   -- apenas 1 registro por meta/mÃªs
...
( 
 ...
 ult_edicao DATE COMMENT 'Data da ultima ediÃ§Ã£o'
)
