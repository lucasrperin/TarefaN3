  ...
  <div class="d-flex-wrapper">
    ...
    <div class="w-100 flex-grow-1 d-flex flex-column">
      <div class="header d-flex justify-content-between align-items-center">
        <h3 class="mb-0"><i class="bi bi-robot me-2"></i>IA - Reforma Tributária</h3>
      ...
      <div class="chat-area access-scroll">
        <div class="chat-header"><i class="bi bi-robot"></i>Agente Reforma Tributária</div>
  ...
  <script>
    ...
    async function enviarImagem(file) {
      ...
      reader.onloadend = async function() {
        ...
        try {
          const resp = await fetch('https://apibotprojeton0.clipp.com.br/upload-imagem-reforma?user_id=' + window.USER_ID, {
            method: 'POST',
            body: formData
          });
    ...
    async function enviarAudio(file) {
      ...
      try {
  const resp = await fetch('https://apibotprojeton0.clipp.com.br/upload-audio-reforma?user_id=' + window.USER_ID, {
          method: 'POST',
          body: formData
        });
