...
(() => {
  ...
  const chamarProcessaVideo = body?.dataset?.chamarProcessaVideo || '../../chatbotreforma/scripts/video/chamar_processa_video.php';
  const chamarProcessaSite  = body?.dataset?.chamarProcessaSite  || '../../chatbotreforma/scripts/website/chamar_processa_site.php';
  ...
  if (formTreino) {
    formTreino.addEventListener('submit', function (e) {
      e.preventDefault();
      console.log('[VIDEO] submit disparado');
      ...
      xhr.onload = function () {
        console.log('[VIDEO] onload - status:', xhr.status);
        console.log('[VIDEO] responseText:', xhr.responseText);
        console.log('[VIDEO] Submit formTreinamento disparado');
        ...
        try { 
          ...
          console.error('[VIDEO] Erro ao parsear JSON:', e);
        }
      ...
      xhr.onerror = function () {
        console.error('[VIDEO] onerror', xhr);
        endUIReset();
