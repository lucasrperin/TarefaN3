...
$dbHost = $_ENV['PG_REFORMA_HOST_HISTORY'];
$dbPort = $_ENV['PG_REFORMA_PORT_HISTORY'];
$dbName = $_ENV['PG_REFORMA_DATABASE_HISTORY'];
$dbUser = $_ENV['PG_REFORMA_USER_HISTORY'];
$dbPass = $_ENV['PG_REFORMA_PASSWORD_HISTORY'];
